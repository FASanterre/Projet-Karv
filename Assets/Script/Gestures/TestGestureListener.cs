...
public class TestGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    private static TestGestureListener instance = null;
	...
	public static TestGestureListener Instance
    {
        get
        {
            return instance;
